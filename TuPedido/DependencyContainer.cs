...
namespace TuPedido
{
    public class DependencyContainer
    {
        public static void RegisterDependencies()
        {
            ...
            Register(new Dates(), typeof(IDates));
            ...
            Register(new DropboxServiceClient(Resolve<IConfiguration>(), Resolve<IDates>()), typeof(IDropboxServiceClient));
            Register(new ExcelHelper(), typeof(IExcelHelper));

            Register(new UserRepository(Resolve<IDatabase<User>>()), typeof(IUserRepository));
            Register(new UserService(Resolve<IRestClient>(), Resolve<IConfiguration>(), Resolve<IDropboxServiceClient>(), Resolve<IExcelHelper>()), typeof(IUserService));
